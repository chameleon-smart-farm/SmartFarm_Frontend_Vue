<template>
  ...
  <div class="text_align mt-3 mb-5"  >
      <div style="display: flex; flex-direction: row; " >
          ...
          <h2 v-once style="margin: 0 auto;" >시리얼 번호 확인</h2>
      </div>
      <hr>
  </div>
  ...
  <div class="mb-4 d-grid" >
      <button class="btn btn-dark" @click="toAddHouse" >다음</button>
  </div>
